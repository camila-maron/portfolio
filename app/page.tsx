...
export default function Portfolio() {
  ...
  const skills = [
    ...
    },
    {
      ...
      icon: Server,
      technologies: ["Node.js", "Express.js", "Java", "PHP", "REST APIs", "Nest.js", "FastAPI", "Prisma"],
    },
    {
    ...
    },
    {
      name: t("skills.tools"),
      icon: Palette,
      technologies: ["Bootstrap", "Ant Design", "Postman", "Jira", "Swagger", "DeepSeek"],
    },
  ]
  ...
  const projects = [
    {
      ...
      technologies: ["React Native", "FastAPI", "Prisma", "MongoDB", "Google Cloud", "DeepSeek"],
      github: "#",
      live: "#",
      featured: true,
      year: "2025",
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-slate-800 bg-slate-950/80 backdrop-blur-xl">
        <div className="container flex h-16 md:h-20 items-center justify-between">
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            >
              <Link
                href={t("nav.resume") === "CV" ? "/CV - Camila Maron.pdf" : "/Resume - Camila Maron.pdf"}
                target="_blank"
          ...
          <div className="lg:hidden border-t border-slate-800 bg-slate-950/95 backdrop-blur-xl">
            <div className="container py-4 space-y-3">
              ...
              >
                <Link
                  href={t("nav.resume") === "CV" ? "/CV - Camila Maron.pdf" : "/Resume - Camila Maron.pdf"}
                  download={t("nav.resume") === "CV" ? "CV - Camila Maron.pdf" : "Resume - Camila Maron.pdf"}
                >
                  <Download className="mr-2 h-4 w-4" />
                  {t("nav.resume")}
                </Link>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-4 md:gap-6 text-center">
                <div className="space-y-2">
                  <div className="text-2xl md:text-3xl font-bold text-purple-400">8+</div>
        ...
        <div className="container">
          ...
          <div className="mt-8 md:mt-12 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-700 bg-slate-800/50 px-4 md:px-6 py-3">
              ...
              <span className="text-sm text-slate-300">{t("personal.comingSoon")}</span>
            </div>
          </div>
        </div>
      </section>
