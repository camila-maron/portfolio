...
export default function Portfolio() {
  ...
  const skills = [
    {
      ...
      icon: Globe,
      technologies: ["JavaScript", "TypeScript", "React", "React Native", "Next.js", "Redux"],
    },
    { name: t("skills.backend"), icon: Server, technologies: ["Node.js", "Express.js", "Java", "PHP", "REST APIs"] },
    { name: t("skills.database"), icon: Database, technologies: ["MySQL", "MongoDB", "SQL Server"] },
    { name: t("skills.testing"), icon: Code2, technologies: ["Jest", "React Testing Library", "Cypress"] },
    { name: t("skills.cloud"), icon: Smartphone, technologies: ["AWS", "Azure", "Docker", "Git"] },
    { name: t("skills.tools"), icon: Palette, technologies: ["Bootstrap", "Ant Design", "Postman", "Jira"] },
  ]
  ...
  const projects = [
    {
      ...
      technologies: ["Node.js", "TypeScript", "Next.js", "React Native", "Redux", "AWS"],
      github: "#",
      live: "#",
      featured: true,
      year: "2024",
    ...
    },
    {
      ...
      technologies: ["Java", "MySQL", "MongoDB", "React", "Bootstrap", "AWS", "Azure"],
      github: "#",
      live: "#",
      featured: true,
      year: "2023",
    ...
    },
    {
      ...
      technologies: ["Next.js", "Node.js", "Express.js", "MongoDB", "Bootstrap", "AWS"],
      github: "#",
      live: "#",
      featured: false,
      year: "2022",
  ...
  const personalProjects = [
    {
      ...
      icon: Code2,
      learningGoals: ["AI Integration", "Advanced TypeScript", "Performance Optimization"],
    },
    {
    ...
    },
    {
      ...
      icon: Smartphone,
      learningGoals: ["Mobile Development", "Device Integration", "Offline-first"],
    },
    {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-slate-800 bg-slate-950/80 backdrop-blur-xl">
        <div className="container flex h-16 md:h-20 items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8 text-sm">
            ...
            <Link href="#personal-projects" className="text-slate-300 hover:text-white transition-colors">
              {t("nav.personal")}
            </Link>
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <Button variant="ghost" size="icon" className="text-slate-300 hover:text-white hover:bg-slate-800" asChild>
              <Link href="https://www.linkedin.com/in/camila-maron/" target="_blank">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/resume.pdf" download="Camila_Maron_Resume.pdf">
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl space-y-6 md:space-y-8">
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="max-w-2xl text-lg md:text-xl text-slate-300 leading-relaxed">{t("hero.description")}</p>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-4 md:gap-6 text-center">
                <div className="space-y-2">
                  <div className="text-2xl md:text-3xl font-bold text-purple-400">7+</div>
                  <div className="text-xs md:text-sm text-slate-400">{t("about.stat1")}</div>
                </div>
                <div className="space-y-2">
                  <div className="text-2xl md:text-3xl font-bold text-pink-400">15+</div>
                  <div className="text-xs md:text-sm text-slate-400">{t("about.stat2")}</div>
                </div>
                <div className="space-y-2">
                  <div className="text-2xl md:text-3xl font-bold text-red-400">3</div>
                  <div className="text-xs md:text-sm text-slate-400">{t("about.stat3")}</div>
                </div>
              </div>
              <div className="relative">
                <div className="h-64 md:h-96 w-full rounded-2xl bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-slate-700 flex items-center justify-center">
                  <div className="text-center space-y-4 px-4">
                    <Code2 className="h-12 w-12 md:h-16 md:w-16 mx-auto text-purple-400" />
                    <div className="text-lg md:text-xl font-semibold">{t("about.subtitle")}</div>
                    <div className="text-sm md:text-base text-slate-400">{t("about.tagline")}</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="experience" className="py-16 md:py-24">
        <div className="container">
          <div className="text-center space-y-4 mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto px-4">{t("experience.subtitle")}</p>
          </div>
          <div className="space-y-6 md:space-y-8">
            {experience.map((exp, index) => (
              ...
              >
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center gap-3">
                        ...
                        <CardTitle className="text-xl md:text-2xl text-white">{exp.company}</CardTitle>
                      </div>
                      <div className="text-base md:text-lg text-purple-300">{exp.role}</div>
                    </div>
                ...
                <CardContent className="p-4 md:p-6 pt-0">
                  ...
                  <div className="space-y-2">
                    <div className="text-sm font-medium text-slate-400">{t("experience.keyProjects")}</div>
      ...
      <section id="skills" className="py-16 md:py-24">
        <div className="container">
          <div className="text-center space-y-4 mb-12 md:mb-16">
            ...
            <div className="h-1 w-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mx-auto"></div>
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto px-4">{t("skills.subtitle")}</p>
          </div>
                ...
                <CardHeader className="pb-4 p-4 md:p-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <CardTitle className="text-lg md:text-xl text-white truncate">{skill.name}</CardTitle>
      ...
      <section id="projects" className="py-16 md:py-24">
        <div className="container">
          <div className="text-center space-y-4 mb-12 md:mb-16">
            ...
            <div className="h-1 w-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mx-auto"></div>
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto px-4">{t("projects.subtitle")}</p>
          </div>
                ...
                <div className="relative p-4 md:p-6 lg:p-8 bg-gradient-to-br from-purple-900/10 to-pink-900/10">
                  <div className="flex items-start justify-between mb-4 md:mb-6">
                    <div className="space-y-2 min-w-0 flex-1">
                      ...
                      <div className="text-xs md:text-sm text-purple-300">{project.type}</div>
                    </div>
                    <div className="flex space-x-2 flex-shrink-0 ml-4">
                      ...
                      >
                        <Link href={project.live} target="_blank">
                          ...
                          <span className="sr-only">{t("common.liveDemo")}</span>
                        </Link>
                      </Button>
                    </div>
                  </div>
                  ...
                  <TechIconGrid technologies={project.technologies} maxVisible={4} showLabels={false} />
                </div>
                <CardContent className="p-4 md:p-6 pt-0">
          ...
          {/* Other Projects */}
          <div className="space-y-6 md:space-y-8">
            <h3 className="text-2xl md:text-3xl font-bold text-center">{t("projects.other")}</h3>
              ...
              {otherProjects.map((project, index) => (
                ...
                >
                  <CardHeader className="pb-4 p-4 md:p-6">
                    <div className="flex items-start justify-between">
                      <div className="space-y-1 min-w-0 flex-1">
                        ...
                        <div className="text-xs text-purple-400">{project.type}</div>
                      </div>
                  ...
                  <CardContent className="pt-0 p-4 md:p-6">
                    ...
                    <TechIconGrid technologies={project.technologies} maxVisible={3} size="sm" />
                  </CardContent>
                </Card>
              ))}
            </div>
      ...
      <section id="personal-projects" className="py-16 md:py-24 bg-slate-900/30">
        <div className="container">
          <div className="text-center space-y-4 mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">{t("personal.title")}</h2>
            <div className="h-1 w-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mx-auto"></div>
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto px-4">{t("personal.subtitle")}</p>
          </div>
          ...
          <div className="grid gap-4 md:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {personalProjects.map((project, index) => (
              <Card
                key={index}
                className="group bg-slate-800/50 border-slate-600 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10"
              >
                <div className="relative p-4 md:p-6 bg-gradient-to-br from-purple-900/5 to-pink-900/5">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-xs text-purple-300 font-medium">{project.status}</div>
                    </div>
                  ...
                  <h3 className="text-base md:text-lg font-bold text-white group-hover:text-purple-300 transition-colors mb-2">
                    {project.title}
                  </h3>
                  <p className="text-sm text-slate-300 mb-4 leading-relaxed">{project.description}</p>
                  <div className="space-y-3">
                    <div className="text-xs text-slate-400 font-medium">{t("personal.learningGoals")}</div>
                    ...
                    <TechIconGrid technologies={project.technologies} maxVisible={4} size="sm" />
                  </div>
                </div>
              </Card>
            ))}
          ...
          <div className="mt-8 md:mt-12 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-700 bg-slate-800/50 px-4 md:px-6 py-3">
              ...
              <span className="text-sm text-slate-300">{t("personal.tagline")}</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-6 md:space-y-8 px-4">
            <div className="space-y-4">
              ...
              <div className="h-1 w-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mx-auto"></div>
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed">{t("contact.description")}</p>
            </div>
