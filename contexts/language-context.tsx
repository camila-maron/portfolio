...
const translations = {
  en: {
    ...
    'about.education':
      'Programming Analyst - National University of Comahue (2017)',
    ...
    'projects.subtitle':
      'Showcasing impactful solutions across healthcare, gaming, and enterprise domains',
    ...
    'personal.subtitle':
      'Side projects and experiments where I explore new technologies and expand my skillset',
  ...
  es: {
    ...
    'about.tagline':
      'Construyendo aplicaciones escalables en diversas industrias',
    'about.description1':
    ...
    'about.education':
      'Analista Programadora - Universidad Nacional del Comahue (2017)',
    ...
    'experience.subtitle':
      'Un recorrido a través de diversas industrias y proyectos desafiantes',
    ...
    'skills.subtitle':
      'Un conjunto integral de herramientas construido a través de años de experiencia práctica',
    'skills.frontend': 'Frontend',
    'skills.backend': 'Backend',
    ...
    'projects.subtitle':
      'Mostrando soluciones impactantes en los dominios de salud, gaming y empresariales',
    ...
    'personal.subtitle':
      'Proyectos paralelos y experimentos donde exploro nuevas tecnologías y amplío mis habilidades',
    'personal.comingSoon': 'En construcción',
