...
const translations = {
  en: {
    ...
    "about.subtitle": "Enterprise Solutions Expert",
    "about.tagline": "Building scalable applications across industries",
    "about.description1":
      "I'm a passionate full-stack developer with over 7 years of experience crafting digital solutions across diverse industries. My expertise spans healthcare applications, gaming platforms, and enterprise business systems.",
    "about.description2":
      "I specialize in modern technologies like React, Node.js, and AWS cloud services, with a strong focus on delivering high-quality, scalable applications. I thrive in collaborative environments and am always seeking growth-oriented opportunities to advance my technical excellence.",
    ...
    "projects.subtitle": "Showcasing impactful solutions across healthcare, gaming, and enterprise domains",
    ...
    // Footer
    "footer.copyright": "© 2024 Camila Maron. Crafted with passion.",
  ...
  es: {
    ...
    "hero.description":
      "Desarrolladora de Software con más de 7 años de experiencia diseñando, desarrollando y manteniendo aplicaciones empresariales escalables en los sectores de salud, gaming y negocios.",
    "hero.location": "Neuquén, Argentina",
    ...
    "about.subtitle": "Experta en Soluciones Empresariales",
    "about.tagline": "Construyendo aplicaciones escalables en diversas industrias",
    "about.description1":
      "Soy una desarrolladora full-stack apasionada con más de 7 años de experiencia creando soluciones digitales en diversas industrias. Mi experiencia abarca aplicaciones de salud, plataformas de gaming y sistemas empresariales.",
    "about.description2":
      "Me especializo en tecnologías modernas como React, Node.js y servicios cloud de AWS, con un fuerte enfoque en entregar aplicaciones escalables y de alta calidad. Prospero en entornos colaborativos y siempre busco oportunidades orientadas al crecimiento para avanzar en mi excelencia técnica.",
    ...
    "skills.tools": "Herramientas y Diseño",

    // Projects Section
    "projects.title": "Proyectos Destacados",
    "projects.subtitle": "Mostrando soluciones impactantes en los dominios de salud, gaming y empresariales",
    ...
    // Footer
    "footer.copyright": "© 2024 Camila Maron. Creado con pasión.",
